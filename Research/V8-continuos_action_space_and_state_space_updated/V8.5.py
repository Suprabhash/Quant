...
if __name__ == "__main__":
    ...
    if multiprocessing_across_starting_points == True:
        best_model_path = multiprocessing_wrapper_for_train_q_learning(ticker,state_lookback,alpha,epsilon,gamma,episodes,all_actions,metric,
                                                                    features,number_of_random_samples,num_dense_layers,num_dense_layers_by_num_features,plot=False)
        print(f"Selected model path = {best_model_path}")
    ...
    fig, score = eval_q_learning(test_df, best_model, state_lookback,all_actions,number_of_random_samples_for_testing, metric, features, save=True)
