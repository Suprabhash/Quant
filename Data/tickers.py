# Contains tickers from NSE,NASDAQ and crypto.
# Dict is keyed using tickers as on Reuters. Corresponding yfinance and investpy tickers can be looked up.
# The starting date of the data uploaded is also provided
# The exchange to which the ticker belongs is also provided
